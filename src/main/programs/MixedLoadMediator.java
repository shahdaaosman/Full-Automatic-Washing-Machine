...
/**
 * This class represents MixedLoad Mediator programe
 * 
 * @author Sahad Osman
 *
 */
public class MixedLoadMediator implements Mediator {
	 ...
	 * @param detergent
	 */
	public MixedLoadMediator(WasherController washer, ColdWaterValve coldWaterValve,
	...
	@Override
	public void start() {
		System.out.println("MixedLoad Program is started ");
		washer.start();
	}
	...
	public void wash() {
		...
		if(levelSensor.checkWaterLevel(level)&&
		 tempSensor.checkTemperature(50)){
