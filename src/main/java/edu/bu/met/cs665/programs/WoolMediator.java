...
/**
 * This class represents Wool Mediator programe
 * 
 * @author Sahad Osman
 *
 */
public class WoolMediator implements Mediator{
	 ...
	 * @param detergent
	 */
	public WoolMediator(WasherController washer, ColdWaterValve coldWaterValve,
	...
	@Override
	public void start() {
		System.out.println("Wool Program is started ");
		washer.start();
	}
	...
	public void wash() {
		...
		if(levelSensor.checkWaterLevel(level)&&
		 tempSensor.checkTemperature(20)){
