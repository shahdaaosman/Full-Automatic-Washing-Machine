...
/**
 * This class represents rinse Mediator programe
 * 
 * @author Sahad Osman
 *
 */
public class RinsMediator implements Mediator {
	 ...
	 * @param detergent
	 */
	public RinsMediator(WasherController washer, ColdWaterValve coldWaterValve,
	...
	@Override
	public void start() {
		System.out.println("Rinse Program is started ");
		washer.start();
	}
